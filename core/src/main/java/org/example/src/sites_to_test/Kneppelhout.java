...
public class Kneppelhout extends ByNewPage {
    ...
    private String[] getSocials(WebElement lawyer) throws LawyerExceptions {
        String email = extractor.extractLawyerText(lawyer, new By[]{By.xpath(".//p[contains(., 'Email')]")}, "EMAIL", LawyerExceptions::phoneException);
        String phone = extractor.extractLawyerText(lawyer, new By[]{By.xpath(".//p[contains(., 'Phone')]")}, "PHONE", LawyerExceptions::phoneException);
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "31104005150" : socials[1]
        );
    }
}
