...
public class GuerraGonzalez extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        return MyDriver.wait.findElements(By.cssSelector("div.vc_grid-item"));
    }

    @Override
    public String openNewTab(WebElement lawyer) throws LawyerExceptions {
        String link = extractor.extractLawyerAttribute(lawyer, new By[]{By.className("vc_gitem-link")}, "LINK", "href", LawyerExceptions::linkException);
