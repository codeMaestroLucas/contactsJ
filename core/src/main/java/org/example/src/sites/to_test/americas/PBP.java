...
public class PBP extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        List<WebElement> lawyers = MyDriver.wait.findElements(By.cssSelector(".results-team__block"));
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.className("team-top-perfil__redes"));
