...
public class GSKStockmann extends ByPage {

    public GSKStockmann() {
        super(
                "GSK Stockmann",
                "https://gsk-lux.com/en/lawyers/",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        List<WebElement> lawyers = MyDriver.wait.findElements(By.className("l7hseov"));
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                "link", extractor.extractLawyerAttribute(lawyer, new By[]{By.className("image")}, "LINK", "href", LawyerExceptions::linkException),
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "35227180200" : socials[1]
        );
    }
}
