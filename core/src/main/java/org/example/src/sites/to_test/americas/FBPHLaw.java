...
public class FBPHLaw extends ByNewPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "firm", this.name,
                "country", "Ecuador",
                "practice_area", extractor.extractLawyerText(container, new By[]{By.xpath("//div[span[text()='Practice areas']]//span[@class='cmsms_features_item_title']")}, "PRACTICE AREA", LawyerExceptions::practiceAreaException),
                "email", socials[0],
