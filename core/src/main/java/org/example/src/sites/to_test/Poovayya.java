...
public class Poovayya extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String email = extractor.extractLawyerText(driver.findElement(By.tagName("body")), new By[]{By.xpath("/html/body/div[2]/div[3]/div/div[2]/div[2]/ul/li[1]/span[2]")}, "EMAIL", LawyerExceptions::emailException);
