...
public class DeLaVegaMartinezRojas extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            List<WebElement> lawyers = MyDriver.wait.findElements(By.className("equipo-item"));
            return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.className("equipo-puesto")}, true);
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String role = extractor.extractLawyerText(lawyer, new By[]{By.className("equipo-puesto")}, "ROLE", LawyerExceptions::roleException);
