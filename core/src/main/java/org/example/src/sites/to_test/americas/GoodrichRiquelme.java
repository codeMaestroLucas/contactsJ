...
public class GoodrichRiquelme extends ByNewPage {

    public GoodrichRiquelme() {
        super(
                "Goodrich Riquelme",
                "https://goodrichriquelme.com/our-people/",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        return MyDriver.wait.findElements(By.cssSelector("li.elementor-icon-list-item"));
    }
