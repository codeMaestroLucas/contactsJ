...
public class Gallant extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            return wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(".pro-list li")));
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String role = extractor.extractLawyerText(container, new By[]{By.className("pro-position")}, "ROLE", LawyerExceptions::roleException);
