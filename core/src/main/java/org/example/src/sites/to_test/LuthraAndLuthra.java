...
public class LuthraAndLuthra extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        List<WebElement> lawyers = driver.findElements(By.className("partner_card"));
        return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.className("partner_title")}, true);
    }
