...
public class Echecopar extends ByPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        List<WebElement> lawyers = MyDriver.wait.findElements(By.cssSelector("article[data-position]"));
        return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.cssSelector("span.font-normal")}, true, validRoles);
    }

    @Override
    protected Object getLawyer(WebElement lawyer) throws Exception {
        String[] socials = this.getSocials(lawyer.findElements(By.tagName("span")), true);
