...
public class Hedman extends ByPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "name", extractor.extractLawyerText(lawyer, new By[]{By.className("teammember__info__name")}, "NAME", LawyerExceptions::nameException),
                "role", extractor.extractLawyerText(lawyer, new By[]{By.className("teammember__info__title")}, "ROLE", LawyerExceptions::roleException),
                "firm", this.name,
                "country", "Estonia",
                "practice_area", "",
                "email", socials[0],
