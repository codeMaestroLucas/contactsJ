...
public class Plesner extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.className("field__item")}, true);
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.className("node__content--aside"));
        String[] socials = super.getSocials(container.findElements(By.className("field__item")), true);
        String practice = extractor.extractLawyerText(container, new By[]{By.className("specialty-container")}, "PRACTICE AREA", LawyerExceptions::practiceAreaException);
