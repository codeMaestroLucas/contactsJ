...
public class DannemannSiemsen extends ByNewPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String role = extractor.extractLawyerText(lawyer, new By[]{By.className("team-level")}, "ROLE", LawyerExceptions::roleException);

        String link = this.openNewTab(lawyer);
        WebElement container = driver.findElement(By.className("director"));
