...
public class WilliamHendrikSiregarDjojonegoro extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            return wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("lqd-tm")));
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.className("ld-fancy-heading"));
