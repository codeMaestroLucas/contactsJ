...
public class FabregaMolinoMulino extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String practice = extractor.extractLawyerText(container, new By[]{By.xpath(".//span[contains(text(),'Practice Areas')]/following::span[1]")}, "PRACTICE AREA", LawyerExceptions::practiceAreaException);
