...
public class JingtianGongcheng extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("li")));
            return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.className("zyry_name")}, true);
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String practice = extractor.extractLawyerText(container, new By[]{By.xpath(".//strong[contains(text(),'Practice:')]/following-sibling::b")}, "PRACTICE AREA", LawyerExceptions::practiceAreaException);
