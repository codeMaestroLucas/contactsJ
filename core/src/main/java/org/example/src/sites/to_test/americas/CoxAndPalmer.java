...
public class CoxAndPalmer extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.className("people-container"));
        ...
        List<WebElement> contactItems = container.findElements(By.cssSelector(".contact-list li"));
        String[] socials = super.getSocials(contactItems, true);
