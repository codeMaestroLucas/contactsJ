...
public class LarrainYAsociados extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "firm", this.name,
                "country", "Chile",
                "practice_area", extractor.extractLawyerText(container, new By[]{By.xpath(".//p[b[contains(.,'Áreas de Práctica')]]/following-sibling::p")}, "PRACTICE AREA", LawyerExceptions::practiceAreaException),
                "email", socials[0],
