...
public class FatimaFreitas extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            List<WebElement> lawyers = MyDriver.getINSTANCE().findElements(By.className("lawyer-link"));
            return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.className("fotopartner")}, false);
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.id("curriculopartner"));
