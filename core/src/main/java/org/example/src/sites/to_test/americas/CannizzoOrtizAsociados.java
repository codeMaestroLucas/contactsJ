...
public class CannizzoOrtizAsociados extends ByNewPage {
    ...
    public String openNewTab(WebElement lawyer) throws LawyerExceptions {
        String url = extractor.extractLawyerAttribute(lawyer, new By[]{By.cssSelector(".nameAbogado a")}, "LINK", "href", LawyerExceptions::linkException);
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        // Coleta áreas de prática da lista principal
        ...
        // Na subpágina, buscamos o cargo (Role) que geralmente aparece no cabeçalho ou logo abaixo do nome
        WebElement container = MyDriver.wait.findElement(By.className("vc_column-inner"));
        
        String role = extractor.extractLawyerText(container, new By[]{By.cssSelector(".wpb_text_column p")}, "ROLE", LawyerExceptions::roleException);
