...
public class Trowers extends ByNewPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String role = extractor.extractLawyerText(lawyer, new By[]{By.className("contact-card__title")}, "ROLE", LawyerExceptions::roleException);

        String link = this.openNewTab(lawyer);
        WebElement container = driver.findElement(By.className("contact-card__caption"));

        String[] socials = super.getSocials(container.findElements(By.tagName("a")), false);
        String country = extractor.extractLawyerText(container, new By[]{By.className("contact-card__location")}, "COUNTRY", LawyerExceptions::countryException);
