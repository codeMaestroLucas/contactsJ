...
public class MPATradeLaw extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String role = extractor.extractLawyerText(lawyer, new By[]{By.className("team-info")}, "ROLE", LawyerExceptions::roleException);
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "551131464330" : socials[1]
        );
    }
}
