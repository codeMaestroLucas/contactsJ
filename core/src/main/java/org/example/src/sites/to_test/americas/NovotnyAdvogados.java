...
public class NovotnyAdvogados extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            return MyDriver.wait.findElements(By.className("advogado-thumb"));
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String role = extractor.extractLawyerText(container, new By[]{By.id("content_67o4bp3ou")}, "ROLE", LawyerExceptions::roleException);
