...
public class Oller extends ByNewPage {

    public Oller() {
        super(
                "Oller",
                "https://ollerabogados.com",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        List<WebElement> lawyers = MyDriver.wait.findElements(By.className("carousel-cell"));
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = MyDriver.wait.findElement(By.className("wrapper-single"));

        String[] socials = this.getSocials(container.findElements(By.cssSelector(".team-social a")), false);
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "50622222222" : socials[1]
        );
    }
}
