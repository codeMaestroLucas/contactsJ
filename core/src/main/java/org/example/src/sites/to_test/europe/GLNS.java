...
public class GLNS extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.tagName("br")}, false);
    }
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String phone = extractor.extractLawyerText(container, new By[]{By.xpath("//span[contains(text(),'T')]/following-sibling::span")}, "PHONE", LawyerExceptions::phoneException);
