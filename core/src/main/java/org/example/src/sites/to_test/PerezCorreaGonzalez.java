...
public class PerezCorreaGonzalez extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            List<WebElement> lawyers = MyDriver.wait.findElements(By.className("aio-icon-component"));
            return lawyers;
        } catch (Exception e) {
            return List.of();
        }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        String name = extractor.extractLawyerText(lawyer, new By[]{By.className("aio-icon-title")}, "NAME", LawyerExceptions::nameException);
