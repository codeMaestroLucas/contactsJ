...
public class MulengaMundashiLegalPractitioners extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "firm", this.name,
                "country", "Zambia",
                "practice_area", extractor.extractLawyerText(container, new By[]{By.xpath("//p[contains(strong,'PRACTICE AREAS')]/following-sibling::p[1]")}, "PRACTICE AREA", (e) -> ""),
                "email", email,
                "phone", phone.isEmpty() ? "260211254248" : phone
        );
    }
}
