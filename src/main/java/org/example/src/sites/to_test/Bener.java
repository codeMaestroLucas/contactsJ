...
public class Bener extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.className("type-vincent_team"));

        String name = extractor.extractLawyerText(container, new By[]{By.className("post-title")}, "NAME", LawyerExceptions::nameException);
        String role = extractor.extractLawyerText(container, new By[]{By.className("team-grid-position")}, "ROLE", LawyerExceptions::roleException);
