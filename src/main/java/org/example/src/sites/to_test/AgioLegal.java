...
public class AgioLegal extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String name = extractor.extractLawyerText(driver.findElement(By.tagName("body")), new By[]{By.className("entry-title")}, "NAME", LawyerExceptions::nameException);
        String role = extractor.extractLawyerText(driver.findElement(By.tagName("body")), new By[]{By.className("job-title")}, "ROLE", LawyerExceptions::roleException);
