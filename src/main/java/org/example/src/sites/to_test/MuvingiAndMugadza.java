...
public class MuvingiAndMugadza extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("et_pb_blurb_content")));
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String email = extractor.extractLawyerText(container, new By[]{By.xpath("//h6[contains(span,'@')]")}, "EMAIL", LawyerExceptions::emailException);
