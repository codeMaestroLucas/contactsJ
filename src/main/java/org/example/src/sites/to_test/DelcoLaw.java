...
public class DelcoLaw extends ByPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "name", extractor.extractLawyerText(lawyer, byName, "NAME", LawyerExceptions::nameException),
                "role", extractor.extractLawyerText(lawyer, byRole, "ROLE", LawyerExceptions::roleException).split("\n")[0],
                "firm", this.name,
                "country", "Panama",
                "practice_area", "",
                "email", socials[0],
