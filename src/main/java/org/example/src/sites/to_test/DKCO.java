...
public class DKCO extends ByPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        if (socials[1].isEmpty()) {
            socials = super.getSocials(lawyer.findElements(By.cssSelector(".field--name-field-employee-phone li")), true);
        }
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "358205274000" : socials[1]
        );
    }
}
