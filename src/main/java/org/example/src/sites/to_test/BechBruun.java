...
public class BechBruun extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "name", extractor.extractLawyerText(driver.findElement(By.className("info__header")), nameBy, "NAME", LawyerExceptions::nameException),
                "role", extractor.extractLawyerText(driver.findElement(By.className("info__position")), roleBy, "ROLE", LawyerExceptions::roleException),
                "firm", this.name,
                "country", "Denmark",
                "practice_area", "",
                "email", socials[0],
