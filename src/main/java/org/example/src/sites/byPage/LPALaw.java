...
public class LPALaw extends ByPage {
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(
                            By.className("blocphoto__content")
                    )
            );
    ...
    private String[] getSocials(WebElement lawyer) {
        ...
        String phone = "";
        try {
            email = lawyer.findElement(By.className("blocphoto__content__mail")).getText();
            phone = lawyer.findElement(By.className("blocphoto__content__tel")).getText();
        } catch (Exception e) {
