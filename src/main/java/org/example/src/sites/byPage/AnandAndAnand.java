...
public class AnandAndAnand extends ByPage {
    ...
    protected void accessPage(int index) throws InterruptedException {
        String otherUrl = "httpsa://www.anandandanand.com/our-team/page/2/";
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("div.attorney-info.card-body.card__background.col-12")));
