...
public class ShahidLaw extends ByPage {
    ...
    public ShahidLaw() {
        super(
                "Shahid Law",
                "https://shahidlaw.com/our-people/",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        String[] validRoles = new String[]{
                "partner", "counsel", "managing", "senior associate"
        };
    ...
    private String getLink(WebElement lawyer) throws LawyerExceptions {
        return lawyer.findElement(By.cssSelector("a[href*='https://shahidlaw.com/team_member/']")).getAttribute("href");
    }
