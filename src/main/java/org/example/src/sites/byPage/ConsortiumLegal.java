...
public class ConsortiumLegal extends ByPage {
    public ConsortiumLegal() {
        super(
            "Consortium Legal",
            "https://consortiumlegal.com/en/specialists/",
            8,
            3
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("contenido-abogado"))
            );
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1] // Phone isn't available on the page
        );
    }
}
