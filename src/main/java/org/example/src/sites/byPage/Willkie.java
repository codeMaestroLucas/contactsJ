...
public class Willkie extends ByPage {
    ...
    private final By[] byRoleArray = {
            By.cssSelector("span.text-14.d-block")
    };
    ...
    public Willkie() {
        super(
                "Willkie",
                // More than 100 pages
                "https://www.willkie.com/professionals?position=all&location=all&page=30",
                1
        );
    }
    ...
    private String getLink(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = new By[]{By.cssSelector("a.h5")};
    ...
    private String getCountry(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = new By[]{
                By.cssSelector("div.contact-info > a:first-of-type")
        };
    ...
    private String[] getSocials(WebElement lawyer) {
        try {
            List<WebElement> socials = lawyer.findElement(By.className("contact-info")).findElements(By.tagName("a"));
