...
public class ClemensLaw extends ByPage {
    public ClemensLaw() {
        super("Clemens Law", "https://clemenslaw.dk/en/medarbejdere/", 1);
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("employee__meta")));
