...
public class LeeAndKo extends ByPage {
    ...
    private String getLink(WebElement lawyer) {
        // Remove all non-numeric digts
        String link = Objects.requireNonNull(lawyer.getAttribute("onclick")).replaceAll("[^0-9]", "");
        return "https://www.leeko.com/leenko/member/memberDetail.do?lang=EN&memberNo=" + link + "&schReturnType=REDIRECT";
    }
