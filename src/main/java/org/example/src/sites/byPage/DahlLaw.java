...
public class DahlLaw extends ByPage {
    public DahlLaw() {
        super(
            "Dahl Law",
            "https://www.dahllaw.dk/en/people/",
            1,
            1
        );
    }
    ...
    protected void accessPage(int index) throws InterruptedException {
        ...
        siteUtl.clickOnAddBtn(By.className("coi-banner__accept"));
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("employeecard__content"))
            );
