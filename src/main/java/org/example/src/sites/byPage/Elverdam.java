...
public class Elverdam extends ByPage {
    private final By[] byRoleArray = {
            By.className("associates__occupation")
    };

    public Elverdam() {
        super(
                "Elverdam",
                "https://elverdam.com/professionals.html",
                1
        );
    }
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(
                            By.cssSelector("a[href^='/professionals/']")
                    )
            );
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "4570606060" : socials[1]
        );
    }
}