...
public class Holst extends ByPage {
    ...
    public Holst() {
        super(
                "Holst",
                "https://www.holst-law.com/personer/",
                1
        );
    }
    ...
    private String[] getSocials(WebElement lawyer) {
        try {
            List<WebElement> socials = lawyer.findElements(By.cssSelector(".profile-card__contacts a"));
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "4589340000" : socials[1]
        );
    }
}