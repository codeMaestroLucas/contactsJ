...
public class BuddleFindlay extends ByPage {

    private final By[] byRoleArray = {
            By.className("member__role")
    };

    public BuddleFindlay() {
        super(
                "Buddle Findlay",
                "https://www.buddlefindlay.com/people#",
                1
        );
    }
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "6493582555" : socials[1]
        );
    }
}