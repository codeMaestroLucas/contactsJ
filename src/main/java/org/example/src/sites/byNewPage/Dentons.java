...
public class Dentons extends ByNewPage {
    public static final Map<String, String> OFFICE_TO_COUNTRY = Map.ofEntries(
            ...
            entry("belo horizonte", "Brazil"),
            entry("bengaluru", "India"),
            entry("berlin", "Germany"),
            entry("birmingham", "USA"),
            entry("bogota", "Colombia"),
            entry("bolivia", "Bolivia"),
            entry("boston", "USA"),
            entry("brasilia", "Brazil"),
            entry("bratislava", "Slovak Republic"),
            entry("brazil", "Brazil"),
            ...
            entry("chile", "Chile"),
            entry("china", "China"),
            entry("christchurch", "New Zealand"),
            entry("cincinnati", "USA"),
            ...
            entry("huntsville", "USA"),
            entry("hyderabad", "India"),
            entry("india", "India"),
            entry("indianapolis", "USA"),
            entry("indonesia", "Indonesia"),
            entry("ireland", "Ireland"),
            entry("istanbul", "Türkiye"),
            entry("italy", "Italy"),
            ...
            entry("jordan", "Jordan"),
            entry("kampala", "Uganda"),
            entry("kansas city", "USA"),
            entry("kazakhstan", "Kazakhstan"),
            entry("kenya", "Kenya"),
            entry("kuala lumpur", "Malaysia"),
            entry("kyiv", "Ukraine"),
            entry("la paz", "Bolivia"),
            entry("lagos", "Nigeria"),
            entry("lebanon", "Lebanon"),
            entry("lehi", "USA"),
            entry("lexington", "USA"),
            entry("liberia", "Costa Rica"),
            entry("lima", "Peru"),
            entry("london", "England"),
            entry("los angeles", "USA"),
            entry("louisville", "USA"),
            entry("lusaka", "Zambia"),
            ...
            entry("new delhi", "India"),
            entry("new orleans", "USA"),
            entry("new york", "USA"),
            ...
            entry("papua new guinea", "Papua New Guinea"),
            entry("paris", "France"),
            ...
            entry("spain", "Spain"),
            entry("st george", "USA"),
            entry("st kitts and nevis", "St. Kitts and Nevis"),
            entry("st louis", "USA"),
            entry("st lucia", "St. Lucia"),
            entry("st vincent and the grenadines", "St. Vincent and The Grenadines"),
            entry("sydney", "Australia"),
            entry("tanzania", "Tanzania"),
            entry("tashkent", "Uzbekistan"),
            entry("tbilisi", "Georgia"),
            entry("tegucigalpa", "Honduras"),
            entry("the shoals", "USA"),
            entry("tokyo", "Japan"),
            entry("toronto", "Canada"),
            entry("trinidad and tobago", "Trinidad and Tobago"),
            entry("tunis", "Tunisia"),
            entry("tunisia", "Tunisia"),
            entry("turkiye", "Türkiye"),
            entry("tuscaloosa", "USA"),
            entry("uganda", "Uganda"),
            ...
            entry("west des moines", "USA"),
            entry("windhoek", "Namibia"),
