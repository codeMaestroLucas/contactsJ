...
public class HHRLawyers extends ByNewPage {
    public HHRLawyers() {
        super(
                "HHR Lawyers",
                "https://www.hhrlawyers.com/page/our-people",
                1
        );
    }
        ...
        try {
            ...
            return wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(
                            By.cssSelector("table tbody tr td a[href*='https://www.hhrlawyers.com/page/our-people/']")
                    )
            );
        } catch (Exception e) {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement div = driver.findElement(By.className("photo-area"));
