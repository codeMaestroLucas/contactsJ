...
public class AshongBenjamin extends ByNewPage {

    public AshongBenjamin() {
        super(
                "Ashong Benjamin",
                "https://ashongbenjamin.com/people/",
                1
        );
    }
    ...
    private String[] getSocials(WebElement lawyer) throws LawyerExceptions {
        String email = extractor.extractLawyerText(lawyer, new By[]{By.className("elementor-icon-list-text")}, "EMAIL", LawyerExceptions::phoneException);
        String phone = extractor.extractLawyerText(lawyer, new By[]{By.xpath(".//li[2]//span[@class='elementor-icon-list-text']")}, "PHONE", LawyerExceptions::phoneException);
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.className("elementor-element-dc871c4"));
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "233302774378" : socials[1]
        );
    }
}
