...
public class IbanezParkman extends ByNewPage {
    String[] validRoles = new String[]{
            "partner",
            "counsel"
    };

    public IbanezParkman() {
        super(
            "Ibañez Parkman",
            "https://i-parkman.mx/en/ourteam/",
            1,
            1
        );
    }
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(
                            By.cssSelector("a[href*='https://i-parkman.mx/en/ourteam/']")
                    )
            );
            lawyers.subList(0, 3).clear();
            lawyers.subList(18, lawyers.size() - 1).clear();
            return lawyers;
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement div = driver
                ...
                .findElement(By.className("elementor-top-section"))
                .findElement(By.className("elementor-container"));
