...
public class HarryEliasPartnership extends ByNewPage {

    private final By[] byRoleArray = {
            By.className("profile-title")
    };

    public HarryEliasPartnership() {
        super(
    ...
    private String getPracticeArea(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = {By.className("profile-specialization")};
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement div = driver.findElement(By.className("mobile-contact-social"));
