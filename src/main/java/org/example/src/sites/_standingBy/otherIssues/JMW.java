...
public class JMW extends ByNewPage {
    ...
    protected void accessPage(int index) throws InterruptedException {
        ...
        if (index == 0) {
            // Click add btn
            MyDriver.clickOnElement(By.id("CybotCookiebotDialogBodyLevelButtonAccept"));
            return;
        } else {
            //the click doesn't loads more lawyers
            MyDriver.clickOnElement(
                    By.xpath("//*[@id=\"__next\"]/div/div[3]/main/div[4]/div/nav/ul/li[9]/button")
            );
        }
