...
public class EsguerraJHR extends ByPage {
    ...
    public EsguerraJHR() {
        super(
                "Esguerra JHR",
                "https://esguerrajhr.com/profesionales/",
                1
        );
    }
    ...
    private String getLink(WebElement lawyer) {
        // No direct link on the card
        return "https://esguerrajhr.com/profesionales/";
    }

    private String getName(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = new By[]{
                By.cssSelector("div.elementor-element-dbdf0d8")
        };
        // Name is split into two h2 tags, so we get the text of the parent
