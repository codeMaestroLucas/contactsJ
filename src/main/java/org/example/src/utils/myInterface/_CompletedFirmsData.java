...
public class _CompletedFirmsData {
    ...
    public final static Site[] byPage = {
            ...
            */
            ...
            new McKercher(), new McMillan(), new MeitarLaw(), new MerilampiAttorneys(), new MijaresAngoitiaCortesAndFuentes(),
    ...
    public final static Site[] byNewPage = {
            ...
            */
            ...
            new Hamso(), new HamsoPatentybra(), new HansOffiaAndAssociates(), new HarteBavendamm(), new HaslingerNagele(),
            ...
            new OneEssexCourt(), new Onsagers(), new Oppenheim(), new Oxera(), new PaviaAndAnsaldo(),
