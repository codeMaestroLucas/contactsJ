...
public class FerreiraPintoCardigos extends ByNewPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        String name = extractor.extractLawyerAttribute(lawyer, new By[]{By.className("card-body")}, "NAME", "textContent", LawyerExceptions::nameException);

        String link = this.openNewTab(lawyer);
        WebElement container = driver.findElement(By.className("pt-5"));
        
        String roleRaw = extractor.extractLawyerAttribute(container, new By[]{By.tagName("h3")}, "ROLE", "textContent", LawyerExceptions::roleException);
