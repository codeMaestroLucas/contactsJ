...
public class GZG extends ByNewPage {

    public GZG() {
        super(
                "GZG",
                "https://gzg.com.cy/people/",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        List<WebElement> lawyers = MyDriver.wait.findElements(By.cssSelector(".group.relative"));
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.cssSelector("div.flex.flex-col.gap-6"));
