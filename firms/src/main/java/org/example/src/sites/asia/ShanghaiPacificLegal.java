...
public class ShanghaiPacificLegal extends ByNewPage {

    public ShanghaiPacificLegal() {
        super(
                "Shanghai Pacific Legal",
                "https://shanghaipacificlegal.com.cn/en/our-people/",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        By[] byRoleArray = {By.className("gdlr-core-personnel-list-position")};

        try {
            WebDriverWait wait = new WebDriverWait(this.driver, Duration.ofSeconds(10L));
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(
                    By.className("gdlr-core-personnel-list"))
            );
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "862160860100" : socials[1]
        );
    }
}
