...
public class LivingstonAlexanderAndLevy extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("div#column-id-1715765497524 div >  div.addon-root-text-block")));
            return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.className("sppb-addon-content")}, false);
        } catch (Exception e) {
    ...
    public String openNewTab(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = {By.cssSelector("h3.sppb-addon-title > a")};
