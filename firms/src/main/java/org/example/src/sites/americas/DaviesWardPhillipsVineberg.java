...
public class DaviesWardPhillipsVineberg extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        String name = extractor.extractLawyerAttribute(lawyer, new By[]{By.className("people-detail-card-large__info__first")}, "NAME", "textContent", LawyerExceptions::nameException);
        String role = extractor.extractLawyerAttribute(lawyer, new By[]{By.className("people-detail-card-large__info__second")}, "ROLE", "textContent", LawyerExceptions::roleException);
