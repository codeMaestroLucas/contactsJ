...
public class Schjodt extends ByPage {

    private final By[] byRoleArray = {
            By.cssSelector("p:nth-of-type(1)")
    };

    public Schjodt() {
        super(
                "Schjodt",
                "https://schjodt.com/people",
                1
        );
    }
...
//        M
    ...
    protected List<WebElement> getLawyersInPage() {
        String[] validRoles = {"partner", "counsel", "adviser", "senior associate", "managing associate"};
        try {
            WebDriverWait wait = new WebDriverWait(this.driver, Duration.ofSeconds(10L));
            List<WebElement> lawyers = wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(
                            By.cssSelector("article[data-people-target]")
                    )
            );
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "4722018800" : socials[1]
        );
    }
}
