...
public class MDPAndPartners extends ByNewPage {
    ...
    private String getName(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = {By.className("team-name")};
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.className("innertrainers"));
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "912261921000" : socials[1]
        );
    }
}
