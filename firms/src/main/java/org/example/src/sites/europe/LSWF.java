...
public class LSWF extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.xpath("//div/div[1]/div[2]"));

        String role = extractor.extractLawyerAttribute(container, new By[]{By.tagName("h1")}, "ROLE", "textContent", LawyerExceptions::roleException);
        ...
        return Map.of(
                ...
                "firm", this.name,
                "country", "Germany",
                "practice_area", extractor.extractLawyerAttribute(container, new By[]{By.cssSelector("p.no-margin-bottom")}, "PRACTICE AREA", "textContent", LawyerExceptions::practiceAreaException),
                "email", socials[0],
