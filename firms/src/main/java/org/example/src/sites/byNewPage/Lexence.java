...
public class Lexence extends ByNewPage {
    ...
    protected void accessPage(int index) throws InterruptedException {
        String otherUrl = "https://www.lexence.com/en/our-people/page/2/?filter_function%5B0%5D=partner-en&query";
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String name = extractor.extractLawyerAttribute(driver.findElement(By.tagName("body")), new By[]{By.tagName("h1")}, "NAME", "textContent", LawyerExceptions::nameException);
        String practice = extractor.extractLawyerAttribute(driver.findElement(By.tagName("body")), new By[]{By.className("bg-oker")}, "PRACTICE AREA", "textContent", LawyerExceptions::practiceAreaException);
