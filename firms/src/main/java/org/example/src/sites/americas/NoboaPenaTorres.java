...
public class NoboaPenaTorres extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            WebElement div = MyDriver.wait.findElement(By.xpath("//*[@id=\"main\"]/div/div[1]/div"));
            List<WebElement> lawyers = div.findElements(By.className("attorney"));

            div = driver.findElement(By.xpath("//*[@id=\"main\"]/div/div[2]/div"));
            lawyers.addAll(div.findElements(By.className("attorney")));
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.className("column-data"));
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "59322970193" : socials[1]
        );
    }
}
