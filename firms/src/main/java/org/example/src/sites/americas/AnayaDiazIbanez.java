...
public class AnayaDiazIbanez extends ByNewPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.xpath("//div/section/div/div[2]/div/section/div/div/div"));
        ...
        return Map.of(
                ...
                "firm", this.name,
                "country", "Mexico",
                "practice_area", extractor.extractLawyerText(driver.findElement(By.tagName("body")), new By[]{By.xpath("//div/section/div/div/div/div/div/div/div/div[1]/div/div/section/div/div/div/div")}, "PRACTICE AREA", LawyerExceptions::practiceAreaException),
                "email", socials[0],
