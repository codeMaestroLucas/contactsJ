...
public class GElíasMuñoz extends ByPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        VCard vCard = VCard.withDefaultPatterns();
        String[] socials = vCard.getSocials(lawyer.findElement(By.cssSelector("a[href*='/sites/default/files/vcards/']")).getAttribute("href"));
