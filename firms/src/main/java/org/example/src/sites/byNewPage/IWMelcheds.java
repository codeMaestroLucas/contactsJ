...
public class IWMelcheds extends ByNewPage {

    private final By[] byRoleArray = {By.tagName("a")};

    public IWMelcheds() {
        super(
                "IW Melcheds",
                "https://iwmelcheds.com.br/equipe/?cargo=socios",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            return MyDriver.wait.findElements(By.className("archive-professionals-card"));
        } catch (Exception e) {
            return List.of();
        }
    }
