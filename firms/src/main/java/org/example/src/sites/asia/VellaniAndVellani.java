...
public class VellaniAndVellani extends ByPage {

    private final By[] byRoleArray = {
            By.tagName("h6")
    };

    public VellaniAndVellani() {
        super(
                "Vellani & Vellani",
                "https://www.vellani.com/our-team",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("media"))
            );
    ...
    private String getLink(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = {By.cssSelector("a.full-pro")};
