...
public class Stek extends ByNewPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = MyDriver.wait.findElement(By.className("team-data"));
        String[] socials = super.getSocials(container.findElements(By.tagName("td")), true);
        socials[0] = super.getSocialsFromText(container.getText())[0];
