...
public class Kondrat extends ByNewPage {
        ...
        try {
            ...
            return wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(
                            By.cssSelector("a[href^='https://kondrat.pl/en/essential_grid/']")
                    )
            );
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement div = driver.findElement(By.className("itemFullText"));
