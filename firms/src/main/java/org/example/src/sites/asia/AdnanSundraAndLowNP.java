...
public class AdnanSundraAndLowNP extends ByNewPage {

    public AdnanSundraAndLowNP() {
        super(
                "Adnan Sundra & Low",
                "https://www.asl.com.my/people/?_role_facet=partners",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            return wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("article.wpgb-card")));
        } catch (Exception e) {
