...
public class IkeyiShittuAndCo extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("div[class*='cp-attorneys-style']")));
