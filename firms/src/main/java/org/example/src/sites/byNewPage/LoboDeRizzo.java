...
public class LoboDeRizzo extends ByNewPage {
    ...
    protected void accessPage(int index) throws InterruptedException {
        ...
        MyDriver.clickOnElementMultipleTimes(
                By.xpath("//*[@id=\"__next\"]/div/main/section[2]/div/div[2]/div[2]/button"),
                10, 0.5
        );
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement content = driver.findElement(By.xpath("//*[@id=\"__next\"]/div/main/div/div[2]/ul"));
        String[] socials = super.getSocialsFromText(content.getText());
