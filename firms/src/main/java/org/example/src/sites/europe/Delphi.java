...
public class Delphi extends ByNewPage {
    ...
    protected void accessPage(int index) throws InterruptedException {
        String otherUrl = "https://www.delphi.se/en/coworkers/page/" + (index + 1) + "/";
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        String role = extractor.extractLawyerText(lawyer, new By[]{By.className("contact-card__title")}, "NAME", LawyerExceptions::nameException);
