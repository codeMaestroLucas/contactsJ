...
public class MoalemWeitemeyer extends ByPage {

    private final By[] byRoleArray = {
            By.className("title")
    };

    public MoalemWeitemeyer() {
        super(
                "Moalem Weitemeyer",
                "https://www.moalemweitemeyer.com/people",
                1
        );
    }
    ...
    protected void accessPage(int index) throws InterruptedException {
        ...
        Thread.sleep(1000L);
        MyDriver.clickOnAddBtn(By.xpath("/html/body/section[2]/div/div/div[2]"));
    }
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "4570701505" : socials[1]
        );
    }
}