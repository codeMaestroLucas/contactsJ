...
public class ShardulAmarchandMangaldasAndCo extends ByNewPage {

    private final By[] byRoleArray = {By.cssSelector("p")};

    public ShardulAmarchandMangaldasAndCo() {
        super(
                "Shardul Amarchand Mangaldas & Co",
                "https://www.amsshardul.com/people/management-board/",
                1
        );
    }
    ...
    private String getRole(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = {By.cssSelector("h3 + p span")};
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement content = driver.findElement(By.id("team"));
