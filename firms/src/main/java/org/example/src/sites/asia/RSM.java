...
public class RSM extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            return this.siteUtl.filterLawyersInPage(lawyers, new By[]{By.className("field--job-title")}, false);
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    private String getName(WebElement lawyer) throws LawyerExceptions {
        return extractor.extractLawyerAttribute(lawyer, new By[]{By.cssSelector("a.inherit-link")}, "NAME", "textContent", LawyerExceptions::nameException);
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "992446006370" : socials[1]
        );
    }
}
