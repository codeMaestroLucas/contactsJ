...
public class SantosElizondo extends ByNewPage {

    public SantosElizondo() {
        super(
                "Santos-Elizondo",
                "https://www.santoselizondo.com/en/team/",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        WebElement div = MyDriver.wait.findElement(By.xpath("//*[@id=\"list_cv_grid\"]/div/div"));
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.xpath("//*[@id=\"jupiterx-main\"]/div/section[3]/div/div/div"));
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "528147771020" : socials[1]
        );
    }
}
