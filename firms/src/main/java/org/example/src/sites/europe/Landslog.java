...
public class Landslog extends ByNewPage {
    ...
    public String openNewTab(WebElement lawyer) throws LawyerExceptions {
        String link = extractor.extractLawyerAttribute(lawyer, new By[]{By.cssSelector("a[href*='https://en.landslog.is/personnel/']")}, "LINK", "href", LawyerExceptions::linkException);
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = MyDriver.wait.findElement(By.xpath("/html/body/div/div/div/div/div[1]/div/div/div/div[2]/div/div"));
