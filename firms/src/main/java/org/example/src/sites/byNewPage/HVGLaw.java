...
public class HVGLaw extends ByNewPage {
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.xpath("//*[@id=\"top\"]/main/section/div[3]"));
        String[] socials = super.getSocials(container.findElements(By.cssSelector("a.btn")), false);
        ...
        return Map.of(
                ...
                "practice_area", area,
                "email", socials[0].replace("?subject=contact", ""),
