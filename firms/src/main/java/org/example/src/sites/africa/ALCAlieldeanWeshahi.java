...
public class ALCAlieldeanWeshahi extends ByNewPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            return wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector(".col-md-4.col-sm-6.mb-30")));
        } catch (Exception e) {
            return List.of();
        }
    }
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "200233364313" : socials[1]
        );
    }
}
