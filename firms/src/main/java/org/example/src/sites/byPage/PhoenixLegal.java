...
public class PhoenixLegal extends ByPage {

    private final By[] byRoleArray = {By.cssSelector(".pro-text p")};

    public PhoenixLegal() {
        super(
                "Phoenix Legal",
                "https://www.phoenixlegal.in/partners.php",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("prtnr-box")));
    ...
    private String getLink(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = {By.cssSelector(".pro-img a")};
        return extractor.extractLawyerAttribute(lawyer, byArray, "LINK", "href", LawyerExceptions::linkException);
    }

    private String getName(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = {By.cssSelector(".pro-text span")};
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "911149830000" : socials[1]
        );
    }
}
