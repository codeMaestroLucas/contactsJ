...
public class ATIM extends ByNewPage {

    private final By[] byRoleArray = {By.className("des")};

    public ATIM() {
        super(
                "ATIM",
                "https://www.atim.com.vn/teams",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("item-teams")));
    ...
    public String openNewTab(WebElement lawyer) throws LawyerExceptions {
        By[] byArray = {By.cssSelector("div.hinh > a")};
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "842873013679" : socials[1]
        );
    }
}