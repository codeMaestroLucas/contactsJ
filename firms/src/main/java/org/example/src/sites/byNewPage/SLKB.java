...
public class SLKB extends ByNewPage {

    public SLKB() {
        super(
                "SLKB",
                "https://slkb.co.za/our-team/",
                1
        );
    }
    ...
    protected List<WebElement> getLawyersInPage() {
        try {
            ...
            List<WebElement> lawyers = wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.className("box-text")));
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "practice_area", "",
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "270114821431" : socials[1]
        );
    }
}
