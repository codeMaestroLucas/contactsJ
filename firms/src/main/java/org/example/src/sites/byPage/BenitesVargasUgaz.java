...
public class BenitesVargasUgaz extends ByPage {
    ...
    public BenitesVargasUgaz() {
        super("Benites, Vargas & Ugaz", "https://bvu.pe/en/nuestro-equipo/", 7);
    }

    @Override
    protected void accessPage(int index) throws InterruptedException {
        String otherUrl = "https://bvu.pe/en/nuestro-equipo/?filter=true&page=" + (index + 1);
    ...
    protected List<WebElement> getLawyersInPage() {
        ...
        for (WebElement lawyer : allLawyers) {
            try {
                String role = extractor.extractLawyerAttribute(lawyer, new By[]{By.className("dmach-postmeta-value")}, "ROLE", "textContent", LawyerExceptions::roleException);
    ...
    public Object getLawyer(WebElement lawyer) throws Exception {
        ...
        return Map.of(
                ...
                "name", extractor.extractLawyerAttribute(lawyer, new By[]{By.className("dmach-post-title")}, "NAME", "textContent", LawyerExceptions::nameException),
                "role", extractor.extractLawyerAttribute(lawyer, new By[]{By.className("dmach-postmeta-value")}, "ROLE", "textContent", LawyerExceptions::roleException),
                "firm", this.name,
                "country", "Peru",
                "practice_area", "",
                "email", socials[0],
