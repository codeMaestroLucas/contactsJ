...
public class Olaechea extends ByNewPage {
    ...
    protected void accessPage(int index) throws InterruptedException {
        String url = "https://www.esola.com.pe/en/search/?search=" + vowels.charAt(index) + "&category=2";
        this.driver.get(url);
    ...
    public String openNewTab(WebElement lawyer) throws LawyerExceptions {
        WebElement anchor = lawyer.findElement(By.xpath(".."));
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = MyDriver.wait.findElement(By.className("et_pb_code_inner"));
