...
public class FalconiPuig extends ByPage {
    ...
    protected List<WebElement> getLawyersInPage() {
        WebElement div = MyDriver.wait.findElement(By.xpath("//*[@id=\"wrapper\"]/div[4]/div/div[2]/div/div/div[2]/div/div/div/div/div[1]/div"));
        List<WebElement> lawyers = div.findElements(By.cssSelector(".stm_staff"));

        div = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div[4]/div/div[2]/div/div/div[4]/div/div/div/div/div[1]/div"));
        lawyers.addAll(div.findElements(By.cssSelector(".stm_staff")));
        return lawyers;
    }
