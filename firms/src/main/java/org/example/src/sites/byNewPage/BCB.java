...
public class BCB extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        ...
        WebElement container = driver.findElement(By.xpath("/html/body/div/div[1]/div/div[1]/div[2]"));
        String[] socials = super.getSocials(container.findElements(By.tagName("a")), false);
        String practice = extractor.extractLawyerText(container, new By[]{By.xpath("/html/body/div/div[1]/div/div[1]/div[2]/div[2]/p[1]/span")}, "PRACTICE AREA", LawyerExceptions::practiceAreaException);
        ...
        return Map.of(
                ...
                "email", socials[0],
                "phone", socials[1].isEmpty() ? "525552638730" : socials[1]
        );
    }
}
