...
public class DaiichiFuyo extends ByPage {
    private final By[] byRoleArray = {
            By.cssSelector(".detail > p:first-child")
    };

    public DaiichiFuyo() {
        super(
                "Daiichi Fuyo",
                "https://daiichi-law.jp/en/lawyers/",
                1
        );
    }
        ...
        try {
            ...
            List<WebElement> lawyers = wait.until(
                    ExpectedConditions.presenceOfAllElementsLocatedBy(
                            By.cssSelector("ul#lawyers_list > li")
                    )
            );
    ...
    private String constructEmail(String name) {
        ...
        return nameParts[nameParts.length - 1] + "@daiichi-law.jp";
    }
