...
public class DeLaVegaMartinezRojas extends ByNewPage {
    ...
    protected Object getLawyer(WebElement lawyer) throws Exception {
        String name = extractor.extractLawyerAttribute(lawyer, new By[]{By.className("equipo-nombre")}, "NAME", "textContent", LawyerExceptions::nameException);

        String link = this.openNewTab(lawyer);

        WebElement container = driver.findElement(By.className("equipo-lay"));
        String text = extractor.extractLawyerAttribute(container, new By[]{By.xpath("./div[2]")}, "CONTENT", "textContent", LawyerExceptions::socialsException);
