...
public class Hugel extends ByPage {
    ...
    public Hugel() {
        super(
                "Hügel",
                "https://www.bpv-huegel.com/en/juristen/",
                1
        );
    }
    ...
    protected void accessPage(int index) throws InterruptedException {
        ...
        Thread.sleep(1000L);
        MyDriver.clickOnAddBtn(By.className("moove-gdpr-modal-save-settings"));
    }
