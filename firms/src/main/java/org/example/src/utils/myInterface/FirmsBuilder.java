...
public class FirmsBuilder {
    ...
    private static final Site[] ASIA = {
            ...
            new FKNKLaw(), new FoongAndPartners(), new FormosanBrothers(), new FoxAndMandal(), new Frasers(),
            new Gall(), new Gallant(), new GanLeeAndTan(), new GKCPartners(), new GLAAndCompany(),
            new GlobalLawOffice(), new GlobalVietnamLawyers(), new GornitzkyAndCo(), new GrandwayLaw(), new GrossAndCo(),
            new GRUBALAW(), new GulapaLaw(), new GuoyaoQindaoLaw(), new HaidermotaAndCo(), new HaiRun(),
            new HaiRun(), new Haiwen(), new Haiwen(), new HalimHongAndQuek(), new HarryElias(),
            new HastingsAndCo(), new Hauzen(), new Helmsman(), new HFAndCo(), new HHRLawyers(),
            new HiswaraBunjaminAndTandjung(), new Hiways(), new HornAndCo(), new HowseWilliams(), new HugillAndIp(),
            new HuiyeLaw(), new HuiZhong(), new HuiZhong(), new Hylands(), new Hylands(),
            new HYLeungAndCo(), new IndiaLawOffices(), new JeffLeongPoonAndWong(), new JiaYuanLaw(), new JinchengTongdaAndNeal(),
            new JingtianGongcheng(), new JingtianGongcheng(), new JIPYONG(), new JointWin(), new JPMLaw(),
            new JTJBInternationalLawyers(), new JunZeJunLaw(), new JuslawsAndConsult(), new K1Chamber(), new KaiRongLaw(),
            new KanKrishme(), new KECOLegal(), new KhaitanAndCo(), new KimChangAndLee(), new KingStubbAndKasiva(),
            new KLaw(), new KochharAndCo(), new KojimaLaw(), new KRBLaw(), new LanbaiLaw(),
            new LAWPartnership(), new LeeAndKo(), new LeeAndLee(), new LeeInternational(), new LeeTsaiAndPartners(),
            new LegacyLaw(), new Lektou(), new LepaMeirAndCo(), new LHAG(), new Llinks(),
            new LNT(), new LonganLaw(), new LSHorizon(), new LuthraAndLuthra(), new MachasAndPartners(),
            new MaheshwariAndCo(), new MakesAndPartners(), new ManuelaAntonio(), new MAQLegal(), new MASLaw(),
            new MatryMeiriAndCo(), new MDLaw(), new MDPAndPartners(), new MeitarLaw(), new Meysan(),
            new MishconKaras(), new MiuraAndPartners(), new MochtarKaruwinKomar(), new MohanadassPartnership(), new MohsinTayebalyAndCo(),
            new MomoOMatsuoAndNamba(), new MoriHamadaAndMatsumoto(), new MorogluArseven(), new MosveldttLaw(), new Mourant(),
            new MVGS(), new MZMLegal(), new NagashimaOhnoAndTsunematsu(), new NumenLaw(), new NunoSimoesAndAssociados(),
            new NurmansyahAndMuzdalifah(), new OcampoAndSuralvo(), new OhEbashiLPCAndPartners(), new OldhamLiAndNie(), new ONC(),
            new OneAsiaLawyers(), new OonBazul(), new Paksoy(), new PhoenixLegal(), new PKWongAndNair(),
            new PlatonMartinez(), new Poovayya(), new PremierChambers(), new ProvidenceLaw(), new PSL(),
            new PunoLaw(), new QuaheWooAndPalmer(), new QuiasonMakalintal(), new RahmatLimAndPartners(), new RajaniAssociates(),
            new RamdasAndWong(), new RCLChambersLaw(), new RemfryAndSagar(), new RHTLaw(), new RIAABarkerGillette(),
            new RiverDeltaLaw(), new RobertsonsSolicitors(), new RomuloLawFirm(), new RP(), new RSM(),
            new SagaLegal(), new SamvadPartners(), new SarafAndPartners(), new SASLO(), new SayatZholshyAndPartners(),
            new SCPT(), new SEUM(), new SFKSLaw(), new SGAndCoLawyers(), new SGLALaw(),
            new ShandongDehengLaw(), new ShanghaiPacificLegal(), new ShardulAmarchandMangaldasAndCo(), new ShiboletAndCo(), new ShinAndKim(),
            new ShoobAndCo(), new ShookLinAndBokNP(), new ShookLinAndBokP(), new ShookLinBok(), new SHorowitzAndCo(),
            new SIGNUM(), new SinghaniaAndPartners(), new SIPLaw(), new Skrine(), new SNRAssociates(),
            new SoemadipradjaAndTaher(), new SoemadipradjaTaher(), new SOIP(), new SokSiphanaAndAssociates(), new SolomonAndCo(),
            new SteinmetzHaringGurman(), new Stellex(), new StevensonWongAndCo(), new StratageLaw(), new SudathPerera(),
            new TALaw(), new TANLaw(), new TannerDeWitt(), new TCLaw(), new TheCapitalLaw(),
            new TianYuan(), new TillekeGibbins(), new TiruchelvamAssociates(), new TMIAssociates(), new TMPIntellectualProperty(),
            new TokyoInternationalLaw(), new TommyThomas(), new Tongshang(), new Trilegal(), new TsarAndTsai(),
            new TSMP(), new TTA(), new TTTAndPartners(), new UMBRA(), new UshijimaAndPartners(),
            new Vaish(), new VALaw(), new VanguardLawyersTokyo(), new VellaniAndVellani(), new VeritasLegal(),
            new VILAF(), new Virtus(), new VisionAndAssociates(), new WangJingAndCo(), new WilliamHendrikSiregarDjojonegoro(),
            new WongPartnership(), new WooKwanLeeAndLo(), new YKVN(), new YoonAndYang(), new YossiLevyAndCo(),
            new YouMe(), new YuenLaw(), new Yulchon(), new YYCLegal(), new ZaidIbrahimAndCo(),
            new ZanHub(), new ZhongLun(), new ZhongLunLaw(), new ZhongziLaw(),
    };
    ...
    private static final Site[] EUROPE = {
            ...
            new Desfilis(), new DGKV(), new DimitrovPetrovAndCo(), new DinovaRusevAndPartners(), new DittmarAndIndrenius(),
            new DKCO(), new DMSLegal(), new Dottir(), new DrzewieckiTomaszek(), new DSMAvocats(),
            new DZPLaw(), new EdwinCoe(), new EisenfuhrSpeiserAndPartner(), new Ekelmans(), new EldibAdvocates(),
            new EliasNeocleous(), new EllisonsSolicitors(), new Elverdam(), new EPAndC(), new ErsoyBilgehan(),
            new Esche(), new Esin(), new Eubelius(), new EuclidLaw(), new EvershedsSutherland(),
            new FCMLimited(), new Fidal(), new FilipAndCompany(), new Finnius(), new Finreg360(),
            new FIVERS(), new FlichyGrange(), new FluegelPreissner(), new FortLegal(), new Foyen(),
            new FPSLaw(), new FrancisWilksAndJones(), new FranklinLaw(), new Frontier(), new FTPA(),
            new Fylgia(), new GanadoAdvocates(), new GElíasMuñoz(), new GeorgievTodorovAndCo(), new GilibertiTriscorniaEAssociati(),
            new GittiAndPartners(), new GladeMichelWirtz(), new GleissLutz(), new GLXLTM(), new GORG(),
            new GorrissenFederspiel(), new GPAAdvogados(), new GPK(), new Granrut(), new GrataInternational(),
            new GreeneAndGreeneSolicitors(), new GreenHorseLegal(), new GrigorescuStefanica(), new GrimaldiAlliance(), new GunAndPartners(),
            new GuttOlkFeldhaus(), new GvWGrafvonWestphalen(), new GVZH(), new Haavind(), new HabrakenRutten(),
            new HammarskioldAndCo(), new Hamso(), new HannesSnellman(), new HarperJamesSolicitors(), new HarteBavendamm(),
            new HaslingerNagele(), new Hayes(), new HCRLegal(), new Hedman(), new Hellstrom(),
            new HjulmandCaptain(), new HoffmannEitle(), new HoffmannLiebs(), new Holmes(), new Holst(),
            new Homburger(), new Horten(), new HoxhaMemiAndHoxha(), new HPPAttorneys(), new Hugel(),
            new HVGLaw(), new HWWHermannWienbergWilhelm(), new IdEstAvocats(), new IlejAndPartners(), new Interlaw(),
            new IoannidesDemetriouLLC(), new isarpatentMunchen(), new JadekAndPensa(), new Jalsovszky(), new JBLaw(),
            new Jeantet(), new JGSA(), new JoffeAndAssocies(), new JoksovicStojanovicAndPartners(), new JonssonAndHall(),
            new Juris(), new JWP(), new Kaimakliotis(), new Kallan(), new KallioLaw(),
            new KambourovAndPartners(), new Kanter(), new KaratzasAndPartners(), new KBVLLaw(), new KCGPartners(),
            new KennedyVanderLaan(), new KewLaw(), new KeystoneLaw(), new KienhuisLegal(), new KLCLaw(),
            new Kneppelhout(), new KnezovicAndAssociates(), new Knijff(), new KochanskiAndPartners(), new KolcuogluDemirkanKocakli(),
            new Kolster(), new Kondrat(), new KonecnaAndZacha(), new Krogerus(), new KromannReumert(),
            new Kvale(), new KWKRLaw(), new LacourteRaquinTatar(), new LAGRO(), new LakatosKovesPartners(),
            new LambadariosLaw(), new Landslog(), new LangsethAdvokat(), new LaszczukAndWspolnicy(), new Legalis(),
            new Legance(), new LeitnerLawRechtsanwalte(), new LemstraVanDerKorst(), new Lener(), new LenzAndStaehelin(),
            new LePooleBekema(), new Lexence(), new LEXIA(), new LEXLogmannsstofa(), new Liedekerke(),
            new Lindahl(), new LindemannSchwennickePartner(), new LLBerg(), new LMCR(), new LMS(),
            new Logos(), new LPAGGV(), new LSWF(), new LSWLaw(), new LundElmerSandager(),
            new LXA(), new Lydian(), new LYND(), new MacedoVitorino(), new MadirazzaPartners(),
            new MaikowskiAndNinnemann(), new MalagaSolicitors(), new MaleckiLegal(), new Maples(), new MAQS(),
            new Mariscal(), new Matheson(), new MazantiAndersen(), new MccannFitzGerald(), new McDermottWillAndEmery(),
            new MellingVoitishkinAndPartners(), new MENACityLawyers(), new MerilampiAttorneys(), new MermozAvocats(), new MeyerKoring(),
            new MFWFialek(), new MihajIlicAndMilanovic(), new Miranda(), new MishcondeReya(), new MitelAndAsociatii(),
            new MLLLegal(), new MMDAdvokati(), new MoalemWeitemeyer(), new Molinari(), new Monard(),
            new MooreLegalKovacs(), new MorrisLaw(), new MPLegal(), new MPRPartners(), new MSBSolicitors(),
            new MSP(), new MusatAsociatii(), new MVJMarkovicVukoticJovkovic(), new MVVPAdvocaten(), new NagyTrocsanyi(),
            new NaschitzBrandesAmir(), new NESTOR(), new NetCraman(), new NGA(), new NGLLegal(),
            new NicolasKanellopoulos(), new NiedererKraftFrey(), new NiederhuberAndPartner(), new Niedermüller(), new NielsenNorager(),
            new Njord(), new NOEWE(), new Norens(), new NovaLaw(), new NPPLegal(),
            new NunzianteMagrone(), new NysinghAdvocatenNotarissenNV(), new Odigo(), new OgletreeDeakins(), new OneEssexCourt(),
            new Onsagers(), new ONVLaw(), new Oppenheim(), new Oppenhoff(), new Orrick(),
            new Orsingher(), new Oxera(), new PanettaConsultingGroup(), new PapapolitisAndPapapolitis(), new PatrikiosPavlouAndAssociates(),
            new PayetReyCauviPerez(), new Pbbr(), new Pedersoli(), new PeliPartners(), new Penta(),
            new PepeljugoskiLaw(), new Pestalozzi(), new PFPLaw(), new PHH(), new PhilipLee(),
            new PhilippeAndPartners(), new PiniFrancoLLP(), new PinneyTalfourdSolicitors(), new Plesner(), new PLMJ(),
            new Ploum(), new PMP(), new POELLATH(), new PolitisPartners(), new PopoviciNituStoicaAndAsociatii(),
            new PortaAndConsulentiAssociati(), new PorwiszAndPartners(), new PotamitisVekris(), new Poulschmith(), new PragerDreifuss(),
            new PricaAndPartners(), new PrinzAndPartner(), new ProskauerRose(), new ProvencaDeCarvalho(), new PrueferAndPartner(),
            new PuschWahlig(), new Quinz(), new Racine(), new RadovanovicStojanovic(), new RadulescuAndMusoi(),
            new RambergAdvokater(), new Rask(), new RBK(), new RBLaw(), new ReinholdCohnGroup(),
            new RKKW(), new RocaJunyent(), new RoedlAndPartner(), new RojsPeljhan(), new Roschier(),
            new RPCLegal(), new RTPR(), new RutgersPosch(), new RuzickaPartners(), new RymarzZdortMaruta(),
            new SadkowskiWspolnicy(), new SalusLegal(), new SampsonCowardLLP(), new SANDS(), new SayinLaw(),
            new SBGK(), new SchalastAndPartner(), new SchellenbergWittmer(), new SchindlerAttorneys(), new Schjodt(),
            new SchneeweissWeixelbaum(), new Schoups(), new SchrammOehler(), new SchurtiPartners(), new ScottoPartners(),
            new SelihAndPartnerji(), new Selmer(), new SenicaPartners(), new ServuloAndAssociados(), new Setterwalls(),
            new SGP(), new Sherrards(), new SibincicNovakPartners(), new Sidley(), new SimonAssocies(),
            new SimontBraun(), new SIRIUS(), new SkauReipurth(), new SkilsLaw(), new SkrastinsDzenis(),
            new SKWSchwarz(), new SlaughterAndMay(), new Snellman(), new SokolNovakTrojanDolecek(), new SouriadakisTsibris(),
            new SPSAdvogados(), new Squair(), new SRSLegal(), new StehlinAssocies(), new Stek(),
            new Stibbe(), new StoneKing(), new Strelia(), new SuarezDeVivero(), new SZA(),
            new Szecskay(), new TEGOS(), new ThomasBodstrom(), new Titov(), new TRINITILawFirm(),
            new TucaZbarcea(), new UriaMenendez(), new Valfor(), new VanDerPutt(), new VanOlmenAndWynant(),
            new VBAdvocates(), new VieringJentschuraAndPartner(), new Vinge(), new Vischer(), new VisionConsulting(),
    ...
    private static final Site[] AMERICAS = {
            ...
            new DeLaVegaMartinezRojas(), new DillonEustace(), new DunnCox(), new ECLegalRubio(), new Farris(),
            new FilionWakelyThorupAngeletti(), new FillmoreRiley(), new FishmanFlanzMelandPaquin(), new FoglerRubinoff(), new Galicia(),
            new Goodmans(), new GrahamThompson(), new Harris(), new HeadrickRizikAlvarezAndFernandez(), new HNA(),
            new IbanezParkman(), new JimenezPena(), new KanukaThuringer(), new KuriBrena(), new Langlois(),
            new Lavery(), new LawsonLundell(), new Leaf(), new LEGlobal(), new Lerners(),
            new LivingstonAlexanderAndLevy(), new LoopstraNixon(), new MalpicaIturbeBujParedes(), new MBM(), new McDougallGauley(),
            new McKercher(), new McKinneyBancroftAndHughes(), new MedinaGarnesAbogados(), new MGGL(), new MijaresAngoitiaCortesAndFuentes(),
            new MLTAikins(), new NaderHayauxAndGoebel(), new NautaDutilh(), new NelliganLaw(), new NunesScholefieldDeLeonAndCo(),
    ...
    private static final Site[] OCEANIA = {
            ...
            new ArnoldBlochLeibler(), new BankiHaddockFiora(), new Baumgartners(), new BellGully(), new BuddleFindlay(),
            new CarterNewell(), new Chamberlains(), new ClaytonUtz(), new ConnollySuthers(), new Corcoran(),
            new Corrs(), new DBHLaw(), new DeutschMiller(), new DoogueGeorge(), new DuncanCotterill(),
            new DWFoxTucker(), new Finlaysons(), new FpaPatent(), new Gadens(), new GilbertAndTobin(),
            new GordonLegal(), new GreenwoodRoche(), new Grette(), new GriffithHack(), new HamiltonLocke(),
            new HarmosHortonLusk(), new HeskethHenry(), new Hicksons(), new HoldingRedlich(), new HWEbsworth(),
            new JamesAndWells(), new JohnsonWinterSlattery(), new LaneNeave(), new MacphersonKelley(), new Madderns(),
            new MalleyAndCo(), new MatthewsFolbigg(), new MayneWetherell(), new MBIP(), new McCulloughRobertson(),
            new MellorOlsson(), new MinterEllisonRuddWatts(), new MorayAndAgnew(), new NormanWaterhouse(), new PiperAlderman(),
            new RussellMcVeagh(), new SierraLegal(), new SimmonsWolfhagen(), new SimpsonGrierson(), new ThomsonGeer(),
            new TompkinsWake(), new WengerVieliAG(), new WilsonHarle(), new WilsonRyanGrose(), new Wrays(),
            new WynnWilliams(), new YoungList(),
    };
