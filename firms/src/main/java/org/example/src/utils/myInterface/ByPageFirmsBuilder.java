...
public class ByPageFirmsBuilder {
    ...
    private static final Site[] AFRICA = {
            ...
            new Ashitiva(), new AVM(), new BentsiEnchillLetsaAndAnkomah(), new CliffeDekkerHofmeyr(), new CoxYeats(),
            new EldibAdvocates(), new EngoruMutebi(), new FisherQuarmbyAndPfeifer(), new KantorAndImmerman(), new ShahidLaw(),
            new SPAAjibadeAndCo(), new STBB(), new TheartMey(), new TripleOKLaw(),
    ...
    private static final Site[] EUROPE = {
            ...
            new AndersenTaxLegalIberia(), new AraozAndRueda(), new ArnesenIP(), new ArnoldAndSiedsma(), new ARQUIS(),
            new ASCHukuk(), new AtlasAdvokater(), new AugustDebouzy(), new AumentoLawFirm(), new BAHR(),
            new BancilaDiaconuSiAsociatii(), new BARDEHLEPAGENBERG(), new BARENTSKRANS(), new BARGERPREKOP(), new Berggren(),
            new Bernitsas(), new BlakeMorgan(), new BlandyAndBlandy(), new BonelliErede(), new BoodleHatfield(),
            new BrinkmannAndPartner(), new Broseta(), new BrownRudnick(), new BSJP(), new BullAndCo(),
            new BureauPlattner(), new BUREN(), new BussMurtonLaw(), new ByrneWallace(), new BYRO(),
            new CampbellsLegal(), new CastrenAndSnellman(), new CBA(), new Cirio(), new Clarkslegal(),
            new ClemensLaw(), new CLPLaw(), new Codex(), new CollasCrill(), new Contrast(),
            new CravathSwaineAndMoore(), new CWAAssociates(), new DahlLaw(), new DavisPolkAndWardwell(), new DechertLLP(),
            new DeClercq(), new Delcade(), new DimitrovPetrovAndCo(), new DinovaRusevAndPartners(), new DKCO(),
            new DMSLegal(), new DrzewieckiTomaszek(), new DZPLaw(), new EldibAdvocates(), new Elverdam(),
            new Esche(), new Esin(), new Eubelius(), new EuclidLaw(), new Fidal(),
            new FilipAndCompany(), new Finreg360(), new FIVERS(), new FlichyGrange(), new FluegelPreissner(),
            new Foyen(), new FranklinLaw(), new GanadoAdvocates(), new GElíasMuñoz(), new GleissLutz(),
            new GorrissenFederspiel(), new GPK(), new GrataInternational(), new GreenHorseLegal(), new GvWGrafvonWestphalen(),
            new Haavind(), new HabrakenRutten(), new HammarskioldAndCo(), new HannesSnellman(), new HarperJamesSolicitors(),
            new HCRLegal(), new Hellstrom(), new HjulmandCaptain(), new Holst(), new HPPAttorneys(),
            new Hugel(), new Jalsovszky(), new JGSA(), new JoffeAndAssocies(), new JoksovicStojanovicAndPartners(),
            new Kallan(), new Kanter(), new KCGPartners(), new KewLaw(), new KienhuisLegal(),
            new KnezovicAndAssociates(), new Knijff(), new KochanskiAndPartners(), new Kolster(), new Krogerus(),
            new KromannReumert(), new LaszczukAndWspolnicy(), new LemstraVanDerKorst(), new LEXIA(), new LEXLogmannsstofa(),
            new Liedekerke(), new Logos(), new LPAGGV(), new Lydian(), new LYND(),
            new MaleckiLegal(), new MAQS(), new Matheson(), new MazantiAndersen(), new MccannFitzGerald(),
            new McDermottWillAndEmery(), new MellingVoitishkinAndPartners(), new MerilampiAttorneys(), new MitelAndAsociatii(), new MMDAdvokati(),
            new MoalemWeitemeyer(), new Molinari(), new MooreLegalKovacs(), new MSP(), new MusatAsociatii(),
            ...
            new Ploum(), new PolitisPartners(), new PopoviciNituStoicaAndAsociatii(), new PorwiszAndPartners(), new PricaAndPartners(),
            new ProskauerRose(), new RadovanovicStojanovic(), new RadulescuAndMusoi(), new RambergAdvokater(), new RBK(),
            new RBLaw(), new RocaJunyent(), new RoedlAndPartner(), new Roschier(), new RPCLegal(),
            new SalusLegal(), new SchindlerAttorneys(), new Schjodt(), new SchurtiPartners(), new SelihAndPartnerji(),
            new Selmer(), new SibincicNovakPartners(), new Sidley(), new SIRIUS(), new SkauReipurth(),
...
// South America
            ...
            new BalmacedaCoxPina(), new BaptistaLuz(), new BarcellosTucunduva(), new BarriosAndFuentes(), new BarrosAndErrazuriz(),
            new BeccarVarela(), new BenitesVargasUgaz(), new Bermudes(), new Bocater(), new BrasilSalomaoeMatthes(),
            new BSVV(), new BullrichFlanzbaum(), new BustamanteFabara(), new CARAdvogados(), new CEPDAbogados(),
            new ChevezRuizZamarripa(), new DiasDeSouza(), new EsguerraJHR(), new FarrocoAbreuGuarnieriZotelli(), new Felsberg(),
            new FLH(), new GNBLaw(), new GSALegal(), new HernandezAndCia(), new LacazMartinsPereiraNetoGurevichAndSchoueri(),
            new LEFOSSE(), new LRILaw(), new MachadoAssociados(), new MachadoMeyer(), new MattosEngelbergEchenique(),
            ...
            new PPOAbogados(), new RennoPenteadoSampaioAdvogados(), new RobortellaEPeres(), new RodrigoEliasMedrano(), new Rubio(),
            new SchneiderPugliese(), new SerranoMartinezCMA(), new Spingarn(), new TauilAndChequer(), new Tavares(),
            new TraviesoEvansArriaAndRengel(), new Tumnet(), new UrendaRencoretOrregoYDorr(), new Vouga(), new WaldAntunesVitaEBlattner(),
    };
